      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Trips User</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.trips_user && Array.isArray(users.trips_user) &&
                              users.trips_user.map((item: any) => (
                                <tr key={item.id} onClick={() => router.push(`/trips/trips-view/?id=${item.id}`)}>
                        ...
                        {!users?.trips_user?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
