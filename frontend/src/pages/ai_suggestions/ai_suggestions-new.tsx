...
import { create } from '../../stores/ai_suggestions/ai_suggestionsSlice'
...
const Ai_suggestionsNew = () => {
  ...
  <FormField label="Trip" labelFor="trip">
      <Field name="trip" id="trip" component={SelectField} options={[]} itemRef={'trips'}></Field>
  </FormField>
...
Ai_suggestionsNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default Ai_suggestionsNew
